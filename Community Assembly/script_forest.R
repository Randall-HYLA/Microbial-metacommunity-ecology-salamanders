...
# Part 2: 
com <- read.csv("forest_otu_table_rarefy.csv", header = T, check.names = F, row.names = 1)
...
bNTI<-read.table("bNTI.group_forest.csv",header=T,sep=",", check.names = F, row.names=1)
