...
# Part 2: 
com <- read.csv("newts_infected_otu_table_rare.csv", header = T, check.names = F, row.names = 1)
...
bNTI<-read.table("bNTI.group_viridescens_infected.csv",header=T,sep=",", check.names = F, row.names=1)
